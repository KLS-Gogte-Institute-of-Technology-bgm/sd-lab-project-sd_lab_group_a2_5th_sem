...
?>
    ...
    <div style="background: black; color: white; text-align: center; padding: 6px;"><h2>Vote for your Candidate</h2></div>
    
<div class="container">
    <form action="index.php" method="post" align="center">
    <ul>
        <li><img src="chirag.jpg" width="280" height="250"/>
        <input type="submit" name="chirag" value="Vote for chirag"/>
        </li>
        <li>
        <img src="nitish.jpg" width="280" height="250"/>
        <input type="submit" name="nitish" value="Vote for nitish"/>
        </li>
        <li>
        <img src="tejaswi.jpg" width="280" height="250"/>
        <input type="submit" name="tejaswi" value="Vote for tejaswi"/>
        </li>
        <li>
        <img src="anant.jpg" width="280" height="250"/>
        <input type="submit" name="anant" value="Vote for anant"/>
        </li>
        <li>
        <img src="sunil.jpg" width="280" height="250"/>
        <input type="submit" name="sunil" value="Vote for sunil"/>
        </li>
        <li>
        <img src="manoj.jpg" width="280" height="250"/>
        <input type="submit" name="manoj" value="Vote for manoj"/>
        </li>
        <li>
        <img src="jitan.jpg" width="280" height="250"/>
        <input type="submit" name="jitan" value="Vote for jitan"/>
        </li>
        <li>
        <img src="bhagirathi.jpg" width="280" height="250"/>
        <input type="submit" name="bhagirathi" value="Vote for bhagirathi"/>
        </li>
        <li>
    </ul>
